      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-6">
            <h2 className="text-3xl font-poppins font-bold text-gray-900 dark:text-white">Our Story</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center">
            ...
            <h3 className="text-2xl font-poppins font-bold text-gray-900 dark:text-white mb-4">Our Vision</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 text-center">
            ...
            <h3 className="text-2xl font-poppins font-bold text-gray-900 dark:text-white mb-4">Our Mission</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        {/* Values */}
        <div className="mb-16">
          <h2 className="text-3xl font-poppins font-bold text-center text-gray-900 dark:text-white mb-12">Our Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Quality First</h3>
              <p className="text-gray-600 dark:text-gray-300">We never compromise on the quality of our ingredients and products.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Student-Centric</h3>
              <p className="text-gray-600 dark:text-gray-300">Every decision we make is with students' needs and preferences in mind.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Sustainability</h3>
              <p className="text-gray-600 dark:text-gray-300">We're committed to environmentally responsible practices and packaging.</p>
            </div>
          </div>
        </div>
        ...
        {/* Team Section */}
        <div className="mb-16">
          <h2 className="text-3xl font-poppins font-bold text-center text-gray-900 dark:text-white mb-12">Meet Our Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-1 text-gray-900 dark:text-white">Abdul Azeem</h3>
              <p className="text-primary-purple dark:text-primary-400 font-medium mb-2">CEO</p>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Visionary leader driving Campus Crunch's mission to revolutionize student nutrition and campus dining experiences.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-1 text-gray-900 dark:text-white">Pranav Rao</h3>
              <p className="text-primary-purple dark:text-primary-400 font-medium mb-2">CTO</p>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Tech innovator building cutting-edge solutions to make healthy snacking accessible and convenient for students.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-1 text-gray-900 dark:text-white">Varsha TM</h3>
              <p className="text-primary-purple dark:text-primary-400 font-medium mb-2">Operations Director</p>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Operations expert ensuring seamless delivery and supply chain management to keep students well-fed.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-poppins font-semibold mb-1 text-gray-900 dark:text-white">Vibhav BS</h3>
              <p className="text-primary-purple dark:text-primary-400 font-medium mb-2">Head of Nutrition</p>
              <p className="text-gray-600 dark:text-gray-300 text-sm">Nutrition specialist ensuring every Campus Crunch product meets the highest health and dietary standards.</p>
            </div>
          </div>
        </div>
