      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            ...
            <h3 className="text-lg font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Save Money</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Up to 33% off regular prices</p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            ...
            <h3 className="text-lg font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Free Delivery</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">No delivery fees on any plan</p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            ...
            <h3 className="text-lg font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Flexible</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Pause, resume, or cancel anytime</p>
          </div>
          ...
          <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            ...
            <h3 className="text-lg font-poppins font-semibold mb-2 text-gray-900 dark:text-white">Exclusive</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm">Access to subscriber-only products</p>
          </div>
        </div>

        {/* Subscription Plans */}
        <div className="mb-16">
          <h2 className="text-3xl font-poppins font-bold text-center text-gray-900 dark:text-white mb-12">
            Choose Your Plan
          </h2>
            ...
            {subscriptionPlans.map((plan) => (
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <h3 className="text-2xl font-poppins font-bold text-gray-900 dark:text-white mb-2">{plan.name}</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-4">{plan.description}</p>
                  
                  <div className="mb-4">
                    <div className="flex items-center justify-center space-x-2 mb-2">
                      <span className="text-3xl font-bold text-primary-purple dark:text-primary-400">₹{plan.price}</span>
                      <span className="text-gray-500 dark:text-gray-400 line-through">₹{plan.originalPrice}</span>
                    </div>
